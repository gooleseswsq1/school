...
/**
 * Extract underlined text from a raw annotated string as SAQ answer.
 * If [[UL]]some text[[/UL]] appears, return the inner text.
 */
export function inferSaqAnswerFromUnderline(rawText: string): string {
