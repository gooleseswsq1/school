                                ...
                                <div className="border-t border-gray-100 dark:border-slate-700 p-4 bg-gray-50 dark:bg-slate-800/50">
                                  {course.children && course.children.length > 0 ? (
                                    ...
                                    <div className="text-center py-4">
                                      <div className="text-sm text-gray-400 mb-3">Khóa học chưa có bài học con</div>
                                      <button
                                        onClick={(e) => { e.stopPropagation(); setActiveCourse(course); setActiveLessonId(course.id); setShowMiniPlayer(true); }}
                                      ...
                                      >
                                        <Play size={14} /> Học nội dung chính
                                      </button>
                                    </div>
                                  )}
                                </div>
